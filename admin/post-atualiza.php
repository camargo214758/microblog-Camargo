...
// Pegar os dados de sessao do usuario logado
$idUsuarioLogado = $_SESSION['id'];
$tipoUsuarioLogado = $_SESSION['tipo'];

// chamamos a função passando os parametros e pegamos o resultado dela
...
/* Se o campo imagem estiver vazio significa que não quer trocar de imagem. Ou seja o sistema vai marcar a imagem */
if( empty ($_FILES['imagem']['name']) ) {
  $imagem = $_POST['imagem-existente'];
} else {

/* Senão, pegue a referencia da nova imagem e faça o processo de upload para o servidor*/
$imagem = $_FILES['imagem']['name'];
upload($_FILES['imagem']);

}
/* Somonte depois do processo de upload (se necessário)
, chamaremos de atualizarpost*/
